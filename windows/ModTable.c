...
#ifdef TWIN_BIN32
extern MAPTABLE MapTableUSER[];
extern MAPTABLE MapTableGDI[];
extern MAPTABLE MapTableKERNEL[];

#define MAPTABLEKERNEL	MapTableKERNEL
#define MAPTABLEUSER	MapTableUSER
#define MAPTABLEGDI	MapTableGDI
#else

#define MAPTABLEKERNEL	0
#define MAPTABLEUSER	0
#define MAPTABLEGDI	0
#endif
...
extern long int RegisterClassEx();
...
{	/* 000 */	{ "USER", 0, 0, 0 },
	...
	/* 18b */	{ "", 0, 0, 0 },
	/* 18c */	{ "", 0, 0, 0 },
	/* 18d */	{ "REGISTERCLASSEX", 0x0008, 0x0c68, RegisterClassEx },
	/* 18e */	{ "", 0, 0, 0 },
	/* 18f */	{ "", 0, 0, 0 },
	/* 190 */	{ "", 0, 0, 0 },
	/* 191 */	{ "", 0, 0, 0 },
...
{	/* nil */	0, 0,
	...
	/* 18b */	Trap, 0,
	/* 18c */	Trap, 0,
	/* 18d */	IT_REGCLASSEX,  RegisterClassEx,
	/* 18e */	Trap, 0,
	/* 18f */	Trap, 0,
	/* 190 */	Trap, 0,
	/* 191 */	Trap, 0,
