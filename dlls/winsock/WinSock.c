                 ...
                 fd_set FAR *exceptfds, const struct timeval FAR *timeout) 
{
 ...
 if (timeout)
  ...
  Select_info->read_fds_info = (fd_set *)readfds;
  Select_info->write_fds_info= (fd_set*)writefds;
  Select_info->except_fds_info= (fd_set*)exceptfds;
