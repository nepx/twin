...
BOOL    WINAPI GetTextExtentPoint32(HDC, LPCSTR, int, SIZE FAR*);
#ifdef TWIN32
...
BOOL    WINAPI GetCharWidthFloat(HDC, UINT, UINT, PFLOAT);
...
BOOL    WINAPI GetCharABCWidthsFloat(HDC, UINT, UINT, LPABCFLOAT);
...
HDC WINAPI CreateEnhMetaFile(HDC, LPCTSTR, CONST RECT *, LPCTSTR);
