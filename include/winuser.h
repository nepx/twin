/*  winuser.h	1.55   SDK Structure definitions, and API's.
...
BOOL	WINAPI SetRect(RECT FAR*, int, int, int, int);
BOOL	WINAPI SetRectEmpty(RECT FAR*);

BOOL    WINAPI CopyRect(RECT FAR*, const RECT FAR*);
...
BOOL	WINAPI OffsetRect(RECT FAR*, int, int);
BOOL	WINAPI InflateRect(RECT FAR*, int, int);
...
#define HWND_TOPMOST        ((HWND)0xffff)
#define HWND_NOTOPMOST      ((HWND)0xfffe)
...
/* If SC_SIZE is defined when stdlib.h is included, undef it (HPUX). */
...
int	WINAPI wsprintf(LPSTR lpszOut, LPCSTR lpszFmt, ...);
...
#define BDR_RAISED		(BDR_RAISEDINNER | BDR_RAISEDOUTER)
...
#define DFCS_CAPTIONRESTORE	0x0004
#define DFCS_CAPTIONHELP	0x0008
