...
SetTextColor(HDC hDC,COLORREF crColor)
{
    ...
    APISTR((LF_APICALL,"SetTextColor(hDC=%x COLORREF=%x)\n",hDC,crColor));
    ...
    APISTR((LF_APIRET,"SetTextColor returns DWORD %x\n",dwRet));
    return dwRet;
}
...
GetTextColor(HDC hDC)
{
    ...
    APISTR((LF_APICALL,"GetTextColor(hDC=%x)\n",hDC));
    ...
    APISTR((LF_APIRET,"GetTextColor returns DWORD %x\n",dwRet));
    return dwRet;
}
...
SetBkColor(HDC hDC,COLORREF crColor)
{
    ...
    APISTR((LF_APICALL,"SetBkColor(HDC=%x,COLORREF=%x)\n",hDC,crColor));
    ...
    APISTR((LF_APIRET,"SetBkColor returns DWORD %x\n",dwRet));
    RELEASEDCINFO(hDC32);
