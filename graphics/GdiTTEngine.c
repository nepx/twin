...
{
        APISTR((LF_APISTUB,"EngineRealizeFont() return WORD 0\n"));
	return 0;
}
...
EngineEnumerateFont(LPSTR lszFace,
		...
		DWORD dw)
{
        APISTR((LF_APISTUB,"EngineEnumerateFont() return int 0\n"));
	return 0;
}
...
{
        APISTR((LF_APISTUB,"EngineDeleteFont() return void\n"));
	return;
}
...
{
        APISTR((LF_APISTUB,"EngineGetGlyphBmp() return long 0\n"));
	return 0;
}
...
{
        APISTR((LF_APISTUB,"EngineGetCharWidth() return void\n"));
	return;
}
...
{
        APISTR((LF_APISTUB,"EngineSetFontContext() return void\n"));
	return;
}
...
{
        APISTR((LF_APISTUB,"GetFontData() return int 0\n"));
	return 0;
}
